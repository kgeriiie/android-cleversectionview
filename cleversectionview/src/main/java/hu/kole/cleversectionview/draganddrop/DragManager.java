package hu.kole.cleversectionview.draganddrop;
...
public class DragManager implements View.OnDragListener {
    ...
    @Override public boolean onDrag(View v, DragEvent event) {
        ...
        switch (event.getAction()) {
            case DragEvent.ACTION_DRAG_STARTED:
                draggingId = itemId;
                adapter.notifyItemChanged(adapter.getPositionForId((int) itemId));
                break;
            ...
            case DragEvent.ACTION_DRAG_LOCATION:
                ...
                int fromPosition = adapter.getPositionForId((int) itemId);
                int toPosition = -1;
            ...
            case DragEvent.ACTION_DRAG_ENDED:
                ...
                recyclerView.getItemAnimator().isRunning(
                        new RecyclerView.ItemAnimator.ItemAnimatorFinishedListener() {
                            @Override public void onAnimationsFinished() {
                                int position = adapter.getPositionForId((int) itemId);
    ...
    @Nullable
    public DragInfo getLastDragInfo() { return lastDragInfo; }
}
